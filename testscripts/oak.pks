...
call @code10
checkflag 0x2F4
if true jump @code11 ' Flag is set
release
end
...
if == jump @code12 ' Equal To
special GET_STEPCOUNT
checkflag 0x2F4
if true call @code13 ' Flag is set
checkflag 0x2F4
if false call @code14 ' Flag is unset
call @code15
return
...
closemsg
compare 0x8009 0x3C
if < jump @code20 ' Smaller Than
checkflag 0x89B
if false jump @code20 ' Flag is unset
pause 0x1E
...
checkflag 0x247
if true jump @code39 ' Flag is set
checkitem POKEBALL 1
compare LASTRESULT 0x0
if == jump @code40 ' Equal To
jump @code4
...
'-----------------------------------
compare 0x4054 0x2
if >= jump @code41 ' Larger Than or Equal To
jump @code4
...
#org @code13
'-----------------------------------
msgbox @text33 ' OAK: Ah, welcome!\pT...
callstd MSG_NOCLOSE ' Non-closing message
return

#org @code14
'-----------------------------------
msgbox @text34 ' OAK: Good to see you...
callstd MSG_NOCLOSE ' Non-closing message
return
...
storevar 0x0 0x8008
storevar 0x1 0x8009
msgbox @text35 ' The amount of progre...
callstd MSG_NOCLOSE ' Non-closing message
checkflag 0x2FF
if false call @code56 ' Flag is unset
call @code57
compare 0x800A 0x0
if == jump @code58 ' Equal To
setvar 0x8004 0x1
special2 LASTRESULT 0xD4
copyvar 0x8008 0x8005
copyvar 0x8009 0x8006
storevar 0x0 0x8008
storevar 0x1 0x8009
msgbox @text36 ' And your NATIONAL PO...
callstd MSG_NOCLOSE ' Non-closing message
...
#org @code59
'-----------------------------------
msgbox @text37 ' I'll be looking forw...
callstd MSG_NOCLOSE ' Non-closing message
jump @code58
...
'-----------------------------------
setflag 0x2F4
msgbox @text38 ' Finally[.]\pYou've f...
callstd MSG_NOCLOSE ' Non-closing message
jump @code58
